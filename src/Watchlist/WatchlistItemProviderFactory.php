...
class WatchlistItemProviderFactory {
	...
	/** @var ExtensionAttributeBasedRegistry|null */
	...
	/**
	 * @return ExtensionAttributeBasedRegistry
	 */
	private function getRegistry(): ExtensionAttributeBasedRegistry {
		if ( $this->registry === null ) {
			$this->registry = new ExtensionAttributeBasedRegistry( self::ATTRIBUTE );
		}
